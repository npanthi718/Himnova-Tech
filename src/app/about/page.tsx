      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 space-y-3 border-brand-cyan/20">
            ...
            <h3 className="text-lg font-bold text-white">Kathmandu HQ</h3>
          ...
          <Card className="p-6 space-y-3 border-purple-400/20">
            ...
            <h3 className="text-lg font-bold text-white">Agentic R&D</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <Card className="p-6 space-y-3 border-emerald-400/20">
            ...
            <h3 className="text-lg font-bold text-white">99.99% Reliability</h3>
            <p className="text-xs text-slate-400 leading-relaxed">

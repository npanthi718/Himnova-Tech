...
export const siteData: SiteConfig = {
  meta: {
    title: "Himnova | Official Himnova Technologies – Custom Software & Cloud IT",
    description:
      "Himnova is Himnova Technologies Private Limited (himnovatech.com), the official IT company behind the Himnova brand. We deliver custom software, cloud DevOps, web platforms, mobile apps, and AI engineering from Kathmandu.",
    keywords: [
      "Himnova",
  ...
  company: {
    ...
    headquarters: {
      ...
      landmark: "Opposite to Deurali Club",
    },
    contact: {
  ...
  footerLinks: {
    ...
    legal: [
      ...
      { label: "Terms of Service", href: "/about#governance" },
      { label: "Security & Sovereignty", href: "/about#governance" },
      { label: "SLA Commitments", href: "/about#governance" },
    ],
  },
};
